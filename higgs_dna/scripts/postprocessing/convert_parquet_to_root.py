...
# Dictionary for renaming variables in ROOT tree output for final fits
    ...
    outfiles = {
        ...
        "vh_70": target_path.replace(
            "merged.root", "output_VHToGG_M70_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_75": target_path.replace(
            "merged.root", "output_VHToGG_M75_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_80": target_path.replace(
            "merged.root", "output_VHToGG_M80_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_85": target_path.replace(
            "merged.root", "output_VHToGG_M85_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_90": target_path.replace(
            "merged.root", "output_VHToGG_M90_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_95": target_path.replace(
            "merged.root", "output_VHToGG_M95_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_100": target_path.replace(
            "merged.root", "output_VHToGG_M100_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_105": target_path.replace(
            "merged.root", "output_VHToGG_M105_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
        "vh_110": target_path.replace(
            "merged.root", "output_VHToGG_M110_13p6TeV_amcatnlo_pythia8.root"                          ### ADDED by CHMA
        ),
